				...
				stage('Tests') {
					timestamps { 
						...
						if(projectType == "NETCORE2") {
							...
							bat "\"${env.OPENCOVER}\\opencover.console.exe\" -output:\"${coverageFolder}\\VisualStudio.Unit.coveragexml\" -register:user -target:\"${env.XUnit}\\xunit.console.exe\" -targetargs:\"${paths} ${traits}\""
