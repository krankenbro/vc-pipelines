			...
			if (env.BRANCH_NAME == 'dev' || env.BRANCH_NAME == 'master') {
                ...
                if (env.BRANCH_NAME == 'master') {
                    stage('Build platform and storefront') {
                        timestamps{
                            build(job: "../vc-platform/${env.BRANCH_NAME}", parameters: [string(name: 'isCaused', value: true)])
                            build(job: "../vc-storefront-core/${env.BRANCH_NAME}", parameters: [string(name: 'isCaused', value: true)])
                        }
                    }
                }
